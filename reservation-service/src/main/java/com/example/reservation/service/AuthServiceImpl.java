...
public class AuthServiceImpl implements AuthService {
    ...
    public Mono<AuthResponse> getAuthResponseMono() {
        WebClient authClient = WebClient.create("http://localhost:8085/auth-service");
        AuthRequest authRequest= AuthRequest.builder().username("admin").password("adminpass").build();
